...
export function FeaturesCardPublish() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0">
      ...
      <div className="absolute top-31.5 -left-65.75 flex w-110.25 flex-col gap-4 rounded-2xl border border-[#1717171A] bg-white p-4 [box-shadow:#1717170D_0rem_0.1875rem_0.9375rem_-0.125rem]">
      ...
      <div className="absolute top-78 -left-42 flex w-86.5 flex-col items-end justify-center gap-4 rounded-2xl border border-[#1717171A] bg-white p-4 [box-shadow:#1717170D_0rem_0.1875rem_0.9375rem_-0.125rem]">
