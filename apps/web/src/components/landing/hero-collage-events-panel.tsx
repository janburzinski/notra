...
export function HeroCollageEventsPanel() {
  return (
    <div className="bg-background relative z-10 h-[52rem] w-[28.125rem] shrink-0 overflow-hidden rounded-3xl border border-black/5 py-5 pr-8 pl-12 transition-transform duration-300 ease-out lg:[transform:perspective(87.5rem)_rotateY(8deg)] lg:motion-safe:hover:[transform:perspective(87.5rem)_rotateY(3deg)_scale(1.03)] dark:border-white/10">
      ...
      <div className="border-border/80 border-b-border/40 bg-muted/80 mt-4 overflow-hidden rounded-lg border shadow-2xs">
        <Table>
          <TableHeader>
            <TableRow>
