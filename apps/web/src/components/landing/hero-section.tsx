        ...
        <div className="relative flex h-full w-full flex-col items-center">
          <div className="flex flex-col items-center gap-8 px-6 pt-28 pb-2 sm:gap-10 sm:pt-24 lg:pt-[7.5rem]">
            <div className="flex flex-col items-center gap-7">
              <h1 className="font-display max-w-[56.875rem] text-center text-[2.5rem] leading-[1.08] font-medium tracking-[-0.015em] text-[#1E1E1E] sm:text-[3.25rem] sm:font-semibold lg:text-[4.75rem] lg:leading-[1.12] dark:text-white">
