                    ...
                    <div className="relative h-full w-full bg-background">
                      <div className="h-full overflow-hidden">
                        <article className="prose prose-stone prose-sm dark:prose-invert h-full max-w-none overflow-hidden px-5 py-4 md:px-6 md:py-5">
                          <p>
                            This week focused on changelog quality, editor
                            polish, and smoother onboarding. We added
                            configurable lookback windows, improved markdown
                            editing reliability, and shipped a progress-aware
                            setup checklist.
                          </p>

                          <h3>
                            Configurable lookback windows for scheduled
                            changelogs
                          </h3>
                          <p>
                            Schedules now support five predefined time ranges
                            (current day, yesterday, last 7/14/30 days) instead
                            of hardcoded 7-day windows. The selected range flows
                            through the entire generation pipeline and appears
                            in stored metadata, so you can see exactly which
                            window produced each post.
                          </p>

                          <h3>Full table support in the rich-text editor</h3>
                          <p>
                            The Lexical editor can now insert, edit, and
                            manipulate tables with a /table slash command and
                            floating action menu. Markdown roundtripping
                            preserves table syntax across view switches, and
                            editor normalization prevents false-positive dirty
                          ...
                          <p>
                            ...
                            Progress is synced across all mutation flows,
                            completion auto-hides the widget, and collapse state
                            persists via localStorage to reduce visual noise.
                          </p>

                          <h3>Modular tone-specific changelog prompts</h3>
                          <p>
                            Changelog generation moved from a shared base prompt
                            to self-contained, one-file-per-tone templates. This
                            simplifies backend selection logic, hardens tool
                            input validation, and centralizes tone profile
                            resolution through Zod schemas.
                          </p>
                          ...
                          <p>
                            Each post now stores a JSONB snapshot of its
                            trigger, repositories, and lookback window. The
                            content detail page displays this metadata with Zod
                            validation and tooltip formatting for multi-repo
                            scenarios.
                          </p>
                        </article>
                      </div>
                      ...
                      <div className="h-full overflow-hidden">
                        <article className="prose prose-stone prose-sm dark:prose-invert h-full max-w-none overflow-hidden px-5 py-4 md:px-6 md:py-5">
                          <p>
                            ...
                            teams would rather automate what goes to their
                            audience than hand-tweak it every time. Still true.
                            But we missed something. Not every ship deserves
                            coverage. Not every commit is worth mentioning. And
                            automatic is not helpful if the output does not
                            sound like you.
                          </p>
                          <p>
                            This week we shipped three things that change how
                            you generate content. They come down to one idea:
                            you decide what gets made and how it sounds.
                          </p>

                          <h2>Generate what you actually want to ship</h2>
                          <p>
                            For the first two months, Notra worked like this:
                            set up a trigger, the AI looks at everything since
                            last time, drafts appear. Fine if you wanted broad
                            coverage. Broke down when you wanted to be
                            selective.
                          </p>
                          <p>
                            So we rebuilt the generate flow. When you create
                            content on-demand now, you see a preview first. The
                            commits, PRs, and releases Notra found. You check
                            boxes for what belongs in your story. Toggle
                            releases on or off. Pick a time window. Scope to
                            specific repos.
                          </p>

                          <h2>Your voice, not a generic one</h2>
                          <p>
                            The other gap we kept hearing: content that looked
                            good but sounded like nobody. Teams would edit our
                            drafts because the tone felt off. Not wrong. Just
                            not theirs.
                          </p>
                          <p>
                            This week we shipped brand voice learning. Add
                            references from your Twitter account (or paste
                            custom text), and Notra's agents study them first,
                    ...
                    <div className="flex h-full flex-col gap-4 overflow-hidden px-5 py-4 md:px-6 md:py-5">
                      <div className="flex flex-col gap-3 rounded-xl border p-4">
                        ...
                        <div className="space-y-2 text-[0.8125rem] leading-relaxed">
                          ...
                          <p>
                            Actually built it over the last week. Major ship.
                          </p>
                          <p>
                          ...
                          <p>
                            We shipped:
                            <br />- Configurable data sources (choose which
                            repos, which commits, which releases)
